...
namespace OrderManagement.Backend.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "AddressId", "Firstname", "Mail", "Name", "Password", "Webpage" },
                values: new object[,]
                {
                    { "1", "1", "Alfred", null, "Koller", null, null },
                    { "21", "21", "Antonia", null, "Faessler", null, null },
                    { "20", "20", "Tamara", null, "Ebneter", null, null },
                    { "19", "19", "Ruedi", null, "Wuerth", null, null },
                    { "18", "18", "Karin", null, "Geher", null, null },
                    { "17", "17", "Nicole", null, "Fritsche", null, null },
                    { "16", "16", "Emanuel", null, "Steingruber", null, null },
                    { "15", "15", "Stefanie", null, "Staub", null, null },
                    { "13", "13", "Patrick", null, "Stadler", null, null },
                    { "12", "12", "Konrad", null, "Mazenauer", null, null },
                    { "11", "11", "Roland", null, "Zumstein", null, null },
                    { "14", "14", "Natascha", null, "Luechinger", null, null },
                    { "10", "10", "Tobias", null, "Wirth", null, null },
                    { "2", "2", "Karl", null, "Meier", null, null },
                    { "23", "10", "Pascal", null, "Koller", null, null },
                    { "4", "4", "Mike", null, "Faessler", null, null },
                    { "5", "5", "Remo", null, "Kessler", null, null },
                    { "6", "6", "Tim", null, "Manser", null, null },
                    { "3", "3", "Marco", null, "Ebneter", null, null },
                    { "8", "8", "Michael", null, "Messmer", null, null },
                    { "22", "8", "Alejandro", null, "Faessler", null, null },
                    { "9", "9", "Berta", null, "Keiser", null, null },
                    { "7", "7", "Martin", null, "Streule", null, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Name", "ParentId", "Price" },
                values: new object[] { "13", "Salami", "4", 8.90m });
            ...
            migrationBuilder.InsertData(
                table: "OrderPositions",
                columns: new[] { "Id", "Count", "OrderId", "Position", "ProductId" },
                values: new object[] { "33", 20, "23", 1, "1" });
            ...
            migrationBuilder.InsertData(
                table: "ProductGroups",
                columns: new[] { "Id", "Name", "ParentId" },
                values: new object[] { "9", "Erdbeeren", "5" });
